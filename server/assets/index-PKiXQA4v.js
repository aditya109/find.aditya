import { r as reactExports, V as jsxRuntimeExports, U as ee } from "./server-BZ2XrYGv.js";
import { c as createLucideIcon, L as Link } from "./router-C4nYUeac.js";
import { d as Vector2, U as UnsignedByteType, S as SRGBColorSpace, D as DepthTexture, e as DepthStencilFormat, f as UnsignedInt248Type, F as FloatType, W as WebGLRenderTarget, L as LinearFilter, g as MeshNormalMaterial, a as Color, N as NearestFilter, B as BasicDepthPacking, E as EventDispatcher, h as LinearSRGBColorSpace, i as NoColorSpace, j as Scene, k as OrthographicCamera, l as Mesh, m as BackSide, n as DoubleSide, o as ShaderMaterial, p as FrontSide, q as NoBlending, r as Uniform, s as Material, T as Texture, R as REVISION, P as PerspectiveCamera, A as AlwaysDepth, t as BufferGeometry, v as BufferAttribute, w as Vector4, x as useThree, H as HalfFloatType, b as useFrame, y as NoToneMapping, z as extend, u as useIsMobile, C as Canvas, G as AdditiveBlending, c as ClientOnly } from "./use-mobile-k2JT7JgB.js";
...
const D = /* @__PURE__ */ reactExports.createContext(null), ie = (e) => (e.getAttributes() & 2) === 2, dt = /* @__PURE__ */ reactExports.memo(/* @__PURE__ */ reactExports.forwardRef(({ children: e, camera: t, scene: o, resolutionScale: r, enabled: a = true, renderPriority: n = 1, autoClear: i = true, depthBuffer: s, enableNormalPass: l, stencilBuffer: p2, multisampling: _ = 8, frameBufferType: S = HalfFloatType }, g) => {
...
const vertexShader = (
  ...
  void main() {
    vec3 pos = position;
    float t = uTime * 0.2;
    float n = snoise(pos * 1.4 + vec3(t, t * 0.7, -t)) * 0.45;
    n += snoise(pos * 2.2 + vec3(-t * 0.8, t * 0.6, t * 0.3)) * 0.15;
    n += uMouse.x * 0.12;
    vNoise = n;
    vec3 displaced = pos + normal * n * uDistort;
...
const fragmentShader = (
  ...
  void main() {
    ...
    float mixA = smoothstep(-0.4, 0.7, vNoise + sin(uTime * 0.2) * 0.15);
...
const FIXED_DT = 1 / 60;
function Blob$1({ mobile }) {
  const meshRef = reactExports.useRef(null);
  const matRef = reactExports.useRef(null);
  const smoothTime = reactExports.useRef(0);
  const accumulator = reactExports.useRef(0);
  const pointerTarget = reactExports.useRef(new Vector2());
  const uniforms = reactExports.useMemo(
    () => ({
      uTime: { value: 0 },
      uDistort: { value: 0.55 },
      uMouse: { value: new Vector2(0, 0) },
      uColorA: { value: new Color("#0d3a2e") },
      uColorB: { value: new Color("#2dd4a8") },
  ...
  useFrame((state, delta) => {
    ...
    if (meshRef.current) {
      meshRef.current.rotation.y = smoothTime.current * 0.08;
      meshRef.current.rotation.x = Math.sin(smoothTime.current * 0.16) * 0.06;
    }
  });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("mesh", { ref: meshRef, scale: mobile ? 1.4 : 1.8, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("icosahedronGeometry", { args: [1, mobile ? 64 : 128] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Canvas,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("pointLight", { position: [5, 5, 5], intensity: 1.2, color: "#73ffb8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Blob$1, { mobile }),
        !mobile && /* @__PURE__ */ jsxRuntimeExports.jsx(dt, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          wt,
          {
            intensity: 0.35,
...
function Particles({ hovered }) {
  const mesh = reactExports.useRef(null);
  const targetSpeed = reactExports.useRef(0);
  const speed = reactExports.useRef(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("points", { ref: mesh, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      style: {
        ...
        transition: hovered ? "transform 0.08s ease-out, box-shadow 0.3s" : "transform 0.4s ease-out, box-shadow 0.3s",
        boxShadow: hovered ? "0 0 24px oklch(0.82 0.18 170 / 0.5), inset 0 0 20px oklch(0.82 0.18 170 / 0.08)" : "0 0 0 oklch(0.82 0.18 170 / 0)",
        border: "1px solid oklch(0.82 0.18 170 / 0.25)",
        background: "oklch(0.22 0.045 235 / 0.8)",
        backdropFilter: "blur(12px)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Canvas,
          {
            dpr: 1,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Particles, { hovered })
          }
        ) }),
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[92vh] overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 grid-bg opacity-40" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClientOnly, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeroShader, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 bg-gradient-to-b from-background/0 via-background/40 to-background pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-8 pt-24 md:pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
          ...
          duration: 0.6
        }, className: "text-sm uppercase tracking-[0.3em] text-primary/80", children: "Senior Software Engineer · Bangalore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.h1, { initial: {
          ...
          duration: 0.8,
          delay: 0.05
        }, className: "mt-5 font-display font-bold leading-[0.95] text-5xl md:text-7xl lg:text-8xl max-w-5xl", children: [
          "Building ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-aurora", children: "durable systems" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
          ...
          duration: 0.8,
          delay: 0.15
        }, className: "mt-6 max-w-2xl text-lg text-muted-foreground", children: "I design event-driven backends, Temporal workflows, and platform services that quietly do the right thing at 3 AM. Currently shipping cloud billing infrastructure at Flexera." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/experience", className: "group inline-flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-full font-medium shadow-mint hover:scale-[1.02] transition-transform", children: [
            "View Experience",
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { size: 18, className: "group-hover:translate-x-1 transition-transform" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "inline-flex items-center gap-2 glass px-6 py-3 rounded-full font-medium hover:border-primary/40 transition-colors", children: "Get in touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ClientOnly, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(FunkyButton, { href: "/Aditya_Resume.pdf", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-5 md:px-8 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-5", children: [{
      icon: Cpu,
      ...
      duration: 0.5,
      delay: i * 0.08
    }, className: "glass rounded-2xl p-6 hover:border-primary/40 transition-colors", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(c.icon, { className: "text-primary mb-4", size: 22 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-semibold", children: c.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground leading-relaxed", children: c.body })
    ] }, c.title)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-auto max-w-7xl px-5 md:px-8 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden glass rounded-2xl py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-12 animate-[marquee_30s_linear_infinite] whitespace-nowrap", children: ["Golang", "Rust", "Python", "Temporal", "Kafka", "PostgreSQL", "MongoDB", "Redis", "AWS", "Kubernetes", "Terraform", "Istio", "ArgoCD", "Aerospike"].concat(["Golang", "Rust", "Python", "Temporal", "Kafka", "PostgreSQL", "MongoDB", "Redis", "AWS", "Kubernetes", "Terraform", "Istio", "ArgoCD", "Aerospike"]).map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-2xl text-muted-foreground/60", children: t }, i)) }) }) }),
