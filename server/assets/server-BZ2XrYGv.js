...
const ee$2 = /* @__PURE__ */ getDefaultExportFromCjs(reactExports);
const isServer = true;
function last(arr) {
...
function ClientOnly({ children, fallback = null }) {
  return useHydrated() ? /* @__PURE__ */ jsxRuntimeExports.jsx(ee$2.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ee$2.Fragment, { children: fallback });
}
function useHydrated() {
  return ee$2.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CmnHSn9X.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C4nYUeac.js").then((n2) => n2.r),
    import("./start-B6XQVWqz.js"),
