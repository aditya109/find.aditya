...
var Route$8 = class Route extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = ee.forwardRef((props, ref) => {
...
const appCss = "/assets/styles-DgfaKpH_.css";
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 inset-x-0 z-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-8 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            "aditya",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-aurora", children: "." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1 glass rounded-full px-2 py-1.5", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: n.to,
          ...
          activeProps: {
            className: "px-4 py-1.5 text-sm rounded-full bg-primary/15 text-primary"
          },
          children: n.label
        },
        n.to
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mx-5 glass rounded-2xl p-3 flex flex-col gap-1 animate-fade-in", children: NAV.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: n.to,
        onClick: () => setOpen(false),
        ...
        activeProps: {
          className: "px-4 py-2 rounded-xl text-sm bg-primary/15 text-primary"
        },
        children: n.label
      },
      n.to
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/50 mt-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 md:px-8 py-8 flex flex-col md:flex-row gap-3 items-center justify-between text-sm text-muted-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Aditya. Built with care & shaders."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-aurora", children: "find.aditya" }),
      " v2"
    ] })
  ] }) });
}
...
const Route$7 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Portfolio of Aditya — Senior Software Engineer building durable distributed systems with Go, Rust, Temporal, Kafka and Kubernetes."
      },
      { name: "author", content: "Aditya" },
      { property: "og:title", content: "Aditya — Backend & Platform Engineer" },
      {
        property: "og:description",
        content: "Senior Software Engineer building durable distributed systems with Go, Rust, Temporal, Kafka and Kubernetes."
      },
...
const $$splitComponentImporter$6 = () => import("./skills-Chrk35Yd.js");
const Route$6 = createFileRoute("/skills")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Languages, platform frameworks, message streaming, databases, cloud & DevOps, and engineering practices Aditya works with."
    }, {
      property: "og:title",
      content: "Skills & Tech — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./publications-BDGJY7Ax.js");
const Route$5 = createFileRoute("/publications")({
  head: () => ({
    meta: [{
      title: "Publications — Aditya"
    }, {
      name: "description",
      content: "Aditya's research publications — Abstractive Text Summarization, NLP, and Deep Learning."
    }, {
      property: "og:title",
      content: "Publications — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./experience-DCUW1irR.js");
const Route$4 = createFileRoute("/experience")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aditya's engineering experience — Senior Software Engineer at Flexera building billing-locking services, Temporal orchestration, and unified connector platforms."
    }, {
      property: "og:title",
      content: "Experience — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-NOX_MI66.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Aditya — backend & platform engineer based in Bangalore."
    }, {
      property: "og:title",
      content: "Contact — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./certifications-BzwwShbG.js");
const Route$2 = createFileRoute("/certifications")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aditya's professional certifications — Certified Kubernetes Administrator and more."
    }, {
      property: "og:title",
      content: "Certifications — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./about-C7PtvehW.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "About Aditya — backend engineer focused on event-driven systems, durable workflows, and platform thinking."
    }, {
      property: "og:title",
      content: "About — Aditya"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-PKiXQA4v.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aditya, Senior Software Engineer at Flexera. I build durable distributed systems with Go, Rust, Temporal and Kafka."
    }, {
      property: "og:title",
      content: "Aditya — Backend & Platform Engineer"
    }]
  }),
...
const PublicationsRoute = Route$5.update({
  id: "/publications",
  path: "/publications",
  getParentRoute: () => Route$7
});
